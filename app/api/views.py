...
from .models import TbDplanificacion, TbDregionGuardia, TbDposta, TbDgrupoGuardia, TbNtipoIncidencia, TbDvariable, TbNhorario, TbRregionHorarioTurno
from .serializers import *


# Create your views here.
class Planificacion_ViewSet(viewsets.ModelViewSet):
...
class RegionGuardia_ViewSet(viewsets.ModelViewSet):
...
class Posta_ViewSet(viewsets.ModelViewSet):
...
class GrupoGuardia_ViewSet(viewsets.ModelViewSet):
...
class TipoIncidencia_ViewSet(viewsets.ModelViewSet):
...
class Variable_ViewSet(viewsets.ModelViewSet):
...
class Turnos_ViewSet(viewsets.ModelViewSet):
...
class Patrones_ViewSet(viewsets.ModelViewSet):
